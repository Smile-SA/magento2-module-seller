...
{
    const FORM_NAME           = 'seller_form';
    const DATA_SOURCE_DEFAULT = 'seller';
    const DATA_SCOPE_PRODUCT  = 'data.seller';

    /**
     * Name of default general panel
     */
    const DEFAULT_GENERAL_PANEL = 'seller-details';
